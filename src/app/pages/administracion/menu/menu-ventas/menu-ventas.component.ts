  ...
  ventasMenu = [
    ...
    },
    {
      ...
      children: [
        ...
        { title: 'Productos sin rotación', route: '/ventas/reportes/productos-sin-rotacion', icon: 'inventory', label: 'Sin rotación', reporte: 'productos-sin-rotacion', feature: C.ReportesAnaliticos, grupoReporte: 'analisis' },
        { title: 'Efectividad de descuentos', route: '/ventas/reportes/efectividad-descuentos', icon: 'percent', label: 'Descuentos', reporte: 'efectividad-descuentos', feature: C.ReportesAnaliticos, grupoReporte: 'analisis' },
        { title: 'Clientes y recurrencia', route: '/ventas/reportes/clientes-recurrencia', icon: 'loyalty', label: 'Recurrencia', reporte: 'clientes-recurrencia', feature: C.ReportesAnaliticos, grupoReporte: 'analisis' },
        { title: 'Incidencias operativas', route: '/ventas/reportes/incidencias-operativas', icon: 'report_problem', label: 'Incidencias', reporte: 'incidencias-operativas', feature: C.ReportesAnaliticos, grupoReporte: 'analisis' },
        { title: 'Calidad documental', route: '/ventas/reportes/calidad-documental', icon: 'verified', label: 'Calidad docs.', reporte: 'calidad-documental', feature: C.ReportesAnaliticos, grupoReporte: 'analisis' },
