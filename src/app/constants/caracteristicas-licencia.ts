...
export const CARACTERISTICAS_LICENCIA = {
  ...
  VentasPagoCuentaOnline: 'ventas.pago_cuenta_online',
...
> = {
  ...
  [CARACTERISTICAS_LICENCIA.VentasPagoCuentaOnline]: [CARACTERISTICAS_LICENCIA.VentasMesa],
  [CARACTERISTICAS_LICENCIA.ReportesAnaliticos]: [CARACTERISTICAS_LICENCIA.OperacionReportes],
